...
_TIMNET_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                           "..", "baselines", "TIM-Net_SER", "Code")
sys.path.insert(0, os.path.abspath(_TIMNET_DIR))
from TIMNET import TIMNET                      # noqa: E402
from Model import WeightLayer                  # noqa: E402
